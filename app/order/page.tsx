                ...
                <div key={cartItem.item.id} className="bg-white rounded-xl p-4 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500 mt-0.5">{cartItem.item.description}</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm space-y-5">
              ...
              <div className="space-y-3">
                ...
                >
                  <CreditCard
                    size={22}
                    className={paymentMethod === 'razorpay' ? 'text-saffron' : 'text-gray-400'}
                  />
                  <div className="text-left">
                    <div className="font-medium text-brown-dark">Pay Online</div>
                    <div className="text-xs text-gray-500">UPI, Card, Net Banking, Wallets</div>
                  </div>
                </button>
              ...
              <button
                ...
                className="w-full bg-saffron hover:bg-saffron-dark text-white py-3.5 rounded-lg font-semibold text-lg transition-colors"
              >
                {paymentMethod === 'razorpay'
